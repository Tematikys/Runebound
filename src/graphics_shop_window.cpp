...
void Client::update_shop_window() {
    ...
    if (m_network_client.get_yourself_character() != nullptr) {
        ...
        //                    }  // HEALTH NUM
        //                    {  // BORDER
        //                        rect = RectangleShape(0, 0, 2 * 10 * 30 * 3 /
        //                        5, 60); tex = SDL_CreateTexture(
        //                            m_graphic_renderer,
        //                            SDL_PIXELFORMAT_RGBA8888,
        //                            SDL_TEXTUREACCESS_TARGET, 2 * 10 * 30 * 3
        //                            / 5 + 1, 60 + 1
        //                        );
        //                        SDL_SetTextureBlendMode(tex,
        //                        SDL_BLENDMODE_BLEND); rect.render_to_texture(
        //                            m_graphic_renderer, tex, {0xFF, 0xFF,
        //                            0xFF, 0xFF}, {0x00, 0xFF, 0x00, 0xFF}
        //                        );
        //                        texture = Texture(tex);
        //                        window->remove_texture("_" + name + "border");
        //                        window->add_texture(
        //                            " " + name + "border", texture, {0, 0},
        //                            true
        //                        );
        //                    }  // BORDER
